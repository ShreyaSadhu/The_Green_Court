...
const shadowHeader = () =>{
    ...
    //Add a class if the bottom offset is greater tab 50 of the viewport
...
sr.reveal('.home__delivery', {delay: 1200, distance: '100px', duration: 1500})
sr.reveal('.home__ingredient', {delay: 1600, interval: 100})
sr.reveal('.recipe__img, .delivery__img, contact__image', {origin: 'left'})
sr.reveal('.recipe__data, .delivery__data, .contact_data', {origin: 'right'})
